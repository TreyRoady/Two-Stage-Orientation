...
//			TRACE(_T("(found extension 0x%I64x)"), type);
			...
			static const QWORD REMOTE_PLUS         = 0x050420A40001ULL;
			static const QWORD MOTION_PLUS_DETECT  = 0x050020a60000ULL;
			static const QWORD REMOTE_PLUS_DETECT  = 0x050020a60001ULL;
			static const QWORD MOTION_PLUS_DETECT2 = 0x050420a60000ULL;
			static const QWORD REMOTE_PLUS_DETECT2 = 0x050420a60001ULL;
			static const QWORD PARTIALLY_INSERTED  = 0xffffffffffffULL;

			// MotionPlus: _before_ it's been activated; Remote_Plus update!
			if (type == REMOTE_PLUS){
				type = MOTION_PLUS;}
			if (type == REMOTE_PLUS_DETECT){
				type = MOTION_PLUS_DETECT;}
			if (type == REMOTE_PLUS_DETECT2){
